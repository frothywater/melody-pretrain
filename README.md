...
python lexicon.py prepare --length 12 --ngram_kind mixed --ngram_dir experiment/dataset/melodynet/ngram/ngram_mixed --lexicon_path experiment/dataset/melodynet/ngram/lexicon_mixed.pkl --label_dir experiment/dataset/melodynet/ngram/label_mixed
...
```bash
python prepare_data.py --granularity 64 --max_bar 128 --pitch_range 0 128 --ngram_length 5 --ngram_top_p 0.3 \
...
--midi_dir ../dataset/melodynet --dataset_dir experiment/dataset/melodynet-12 \
--pitch_ngram_dir experiment/dataset/melodynet/ngram/label_pitch \
--rhythm_ngram_dir experiment/dataset/melodynet/ngram/label_rhythm
...
### 3 Pretrain
```bash
python generate_script.py --dataset_dir experiment/dataset/melodynet --experiment_dir experiment/ablation_ngram
